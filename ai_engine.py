...
GEMSTONES = {
    ...
    "মংগল": "পোৱাল (Coral)",
    "বুধ": "পান্না (Emerald)",
    "বৃহস্পতি": "পুখৰাজ (Yellow Sapphire)",
    "শুক্ৰ": "হীৰা (Diamond)",
    "শনি": "নীলমণি (Blue Sapphire)",
    "ৰাহু": "গোমেদ (Hessonite)",
    "কেতু": "লহচুনীয়া (Cat's Eye)",
}
...
def generate_gemstone_recommendation(asc_rasi_idx: int, planet_signs: dict) -> str:
    ...
    lines.append("• ৰত্ন সোঁহাতৰ (right hand) নিৰ্দিষ্ট আঙুলিত ধাৰণ কৰিব লাগে।")
    lines.append("")
...
def generate_ai_interpretation(
    ...
    lines.append("")
    lines.append("ধ্ৰুৱতৰা AIৰ দ্বাৰা আপোনাৰ কুণ্ডলীৰ বিশ্লেষণ আগবঢ়োৱা হ'ল। এই বিশ্লেষণ বৈদিক জ্যোতিষ শাস্ত্ৰৰ শুদ্ধ গণনাৰ আধাৰত প্ৰস্তুত কৰা হৈছে।")
    lines.append("")
